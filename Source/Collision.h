...
public:
	...
	bool isHitBox(const DirectX::XMFLOAT2& min1, const DirectX::XMFLOAT2& max1, const DirectX::XMFLOAT2& min2, const DirectX::XMFLOAT2& max2);
	static bool HitCubeCheak(const DirectX::XMFLOAT3& min1, const DirectX::XMFLOAT3& max1, const DirectX::XMFLOAT3& min2, const DirectX::XMFLOAT3& max2);
