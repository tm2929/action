...
#include"misc.h"
#include <functional>
AttackLine* AttackLine::attackLine = nullptr;
AttackLine::AttackLine(ID3D11Device* device)
{
	HRESULT hr = S_OK;
	vertex vertices[] =
	{
		{ DirectX::XMFLOAT3(-0.5f,   0.f,  0.0f), DirectX::XMFLOAT4(1,1,1,1)},
		{ DirectX::XMFLOAT3(+0.5f,  0.f,  0.0f), DirectX::XMFLOAT4(1,1,1,1)},
		{ DirectX::XMFLOAT3(-0.5f,   0.f,  1.0f), DirectX::XMFLOAT4(1,1,1,1)} ,
		{ DirectX::XMFLOAT3(+0.5f,  0.f,  1.0f), DirectX::XMFLOAT4(1,1,1,1)},
	};
	// 入力レイアウト
...
void AttackLine::Render(ID3D11DeviceContext* immediate_context, const DirectX::XMFLOAT4X4 viewProjection, const DirectX::XMFLOAT4& color)
{
